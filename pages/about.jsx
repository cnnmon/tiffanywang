  ...
  return (
    <>
      ...
      <p>
        <b>✧･ﾟ: *✧･ﾟ:*</b>
        <br /><br />
        In a past life, I was an indie game dev. Growing up in Cleveland, OH, I was first exposed to coding via Flash games. I started drawing up games of my own, doing everything from art to music to code; I frequented game jams, featured in two exhibitions, and published on <a href="https://cnnmon.itch.io/" target="_blank" className="link">itch.io</a> <FaItchIo className="clear-left inline" />.
        <br /><br />
